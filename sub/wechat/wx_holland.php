...
class wechat {
	...
	function getActivityArray($sceneId) { //通用获取活动信息方法
		...
		if ("1" == $type) { //文字回复
			...
			$content [] = array ('Title' => $activity->getTitle ( 0 ), 'Description' => $activity->getDescription ( 0 ), 'PicUrl' => $activity->getPicUrl ( 0 ), 'Url' => $activity->getMessageUrl ( 0 ) );
			/*
