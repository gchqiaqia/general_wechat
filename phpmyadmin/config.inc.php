 ...
 * characters.
 */
$cfg['blowfish_secret'] = 'comsenzdiscuzexp';
...
$i++;
$cfg['Servers'][$i]['host']          = SAE_MYSQL_HOST_M; // MySQL hostname or IP address
$cfg['Servers'][$i]['port']          = SAE_MYSQL_PORT;          // MySQL port - leave blank for default port
...
$cfg['LoginCookieValidity']     = 18000000;   // validity of cookie login (in seconds)
