...
function folder_info($path){
	$a_size_info=_path_info_more($path);
	$info = array(
		...
		'is_readable'	=> intval(is_readable($path)),
		'is_writeable'	=> intval(is_writeable($path)),
		'size'	=> $a_size_info['size'],
	    'size_friendly'	=> $a_size_info['size_friendly'],
	    'file_num'	=> $a_size_info['file_num'],
	    'folder_num'	=> $a_size_info['folder_num']
	);
	return $info;
}
